export const MESSAGES = {
  ...
  nowPlaying: (song: string | undefined) => `Now playing: "${song}"`,
  songAdded: (song: string | undefined) => `Added "${song}" to the queue.`,
  playlistAdded: (playlist: string | undefined, count: number) => `Added playlist "${playlist}" (${count} songs) to the queue.`,
}
